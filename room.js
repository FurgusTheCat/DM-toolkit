  ...
  function generateDescription(){
    ...
    // Medium complexity (longer single-paragraph forms)
      ...
      const longTemplates = [
        ...
        `Stepping inside, you are greeted by a ${pick(adjs, rng)} chamber where ${pick(scents, rng)} lingers. ${pick(items, rng)} can be seen beside ${props.length ? props.join(', ') : 'some scattered belongings'}, and the overall effect is ${pick(adjs, rng)}.`
      ];
